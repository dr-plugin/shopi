 ...
 */
class shtcButtons extends Base_Data_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'shopi-buttons-control', SH_THEME_URL . 'assets/ele/js/buttons.js', [ 'jquery' ], '1.0.0' , false );
	}
