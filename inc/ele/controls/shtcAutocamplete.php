 ...
 * @since 1.0.0
 */
class shtcAutocamplete extends Base_Data_Control
{
	/**
	...
	{
		wp_enqueue_script( 'shopi-autocomplete-control', SH_THEME_URL . 'assets/ele/js/autocomplete.js', [ 'jquery' ], '1.0.0' , false );
	}
